...
const insertReadings =
  `INSERT INTO readings (user_id,date,sugarB,carbsB,insulinB,
    ...
    insulinBed,insulinSBed,insulinFBed,chkMedsBed) VALUES (
    ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);
    ${copyReadingsTable};`;
...
const updateReading =
  `SET @id=?;SET @user_id=?;SET @date=?;SET @sugarB=?;SET 
